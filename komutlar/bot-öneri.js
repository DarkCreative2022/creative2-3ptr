...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2022`);

const onerili = new Discord.MessageEmbed()
.setColor(AloneDogru)
.setTitle("Creative | Başarılı")
...
.setFooter(`©️ Tüm hakları saklıdır | Yeni Nesil Gelişmiş Bot | 2022`);  
  ...
  var guildID = "895033012885004288"; // Sunucu ID
 
  var channelID = "931863276625727528"; // Kanal ID
