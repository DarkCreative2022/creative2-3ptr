...
exports.run = async (bot, msg, args) => {
        ...
        .replace("dnd", `<a:dnd:931923005666369646>  | **Rahatsız Etmeyin**`)
        .replace("online", `<a:online:931923134335037450>    | **Çevrimiçi**`)
        .replace("idle", `<a:idle:931923073442127923>  | **Boşta**`)
        .replace("offline", `<a:offline:931923499998666752>  | **Çevrimdışı**`)
        ...
        .setFooter(`Creative Bot | Kullanıcı Bilgi Sistemi`)
