...
exports.run = (client, message, args) => {
     if (!message.member.hasPermission("BAN_MEMBERS")) return message.channel.send(`<:discord:904302383729889311> **Bu komutu kullanabilmek için "\`Üyeleri Yasakla\`" yetkisine sahip olmalısın.**`);

	if (!message.guild) return message.author.send('<:discord:904302383729889311> **Bu Komutu Sunucuda Kulanabilirsiniz**');
...
const Embed = new Discord.MessageEmbed()
 .setColor('#ffffff')
.setAuthor('Creative | Ban Sorgulama', client.user.avatarURL())
