...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<:no:915579751886880858> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
 ...
 if(!rol) return message.reply(`<:no:915579751886880858> **Bu özellik zaten kapalı! :wink: **`)
 
 
  message.channel.send(`<:blue_tick_1:915575001787289642> **Kayıt Sistemi başarılı bir şekilde kapatıldı.**`)
