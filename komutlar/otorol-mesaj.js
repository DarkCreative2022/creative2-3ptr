...
if (!message.member.hasPermission("ADMINISTRATOR")) return message.channel.send(`<:no:915579751886880858> **Bu komutu kullanabilmek için** "\`Yönetici\`" **yetkisine sahip olmalısın.**`);
  ...
  if(mesaj.length < 5) return message.channel.send('<:blue_tick_1:915575001787289642> **Sayaç Hoşgeldin Mesaj Sistemi İçin En Az 5 Karakter Belirtebilirsin!**\n `**__Örnek__**: `-oto-rol-msg -uye- Hoşgeldin! senle beraber -uyesayisi- Kişiyiz!`')
  
 message.channel.send('<:blue_tick_1:915575001787289642> **Oto-Rol mesajı** `'+mesaj+'` **Olarak ayarlandı!**') 
