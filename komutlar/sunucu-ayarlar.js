...
const sayfa = [`**${message.guild.name} | Sunucu Ayarları**\n**Botun Prefixi :** \`${p}\n**Reklam Engel:** ${db.fetch(`reklamengel_${message.guild.id}`) ? `<:acik:932324487809073232>` : `<:kapali:932324541483614268>` }\n**Küfür Engel:** ${db.fetch(`kufurE_${message.guild.id}`) ? `<:acik:932324487809073232>` : `<:kapali:932324541483614268>` }`] 
